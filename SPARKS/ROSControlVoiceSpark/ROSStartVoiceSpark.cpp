...
{
        if (!strcmp(componentType, "ROSStartVoiceSpark"))
                return new ROSStartVoiceSpark(componentInstanceName,componentSystem);
        else
                return NULL;
}
#endif

// Initializes the ROSStartVoiceSpark component.

void ROSStartVoiceSpark::init(void){
...
/// Uninitializes the ROSStartVoiceSpark component.

void ROSStartVoiceSpark::quit(void) {
}

void ROSStartVoiceSpark::process(){
	ros::NodeHandle n;
