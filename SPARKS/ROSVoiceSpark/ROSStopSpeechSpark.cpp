...
{
        if (!strcmp(componentType, "ROSStopSpeechSpark"))
                return new ROSStopSpeechSpark(componentInstanceName,componentSystem);
        else
                return NULL;
}
#endif

// Initializes the ROSStopSpeechSpark component.

void ROSStopSpeechSpark::init(void){
...
/// Uninitializes the ROSStopSpeechSpark component.

void ROSStopSpeechSpark::quit(void) {
}

void ROSStopSpeechSpark::process(){
	ros::NodeHandle n;
