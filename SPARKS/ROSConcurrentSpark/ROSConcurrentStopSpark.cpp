#include "ROSConcurrentStopSpark.h"
...
{
        if (!strcmp(componentType, "ROSConcurrentStopSpark"))
                return new ROSConcurrentStopSpark(componentInstanceName,componentSystem);
        else
                return NULL;
}
#endif

// Initializes the ROSConcurrentStopSpark component.

void ROSConcurrentStopSpark::init(void){
...
/// Uninitializes the ROSConcurrentStopSpark component.

void ROSConcurrentStopSpark::quit(void) {
}

void ROSConcurrentStopSpark::process(){
	ros::NodeHandle n;
