...
{
        if (!strcmp(componentType, "ROSShowSpark"))
                return new ROSShowSpark(componentInstanceName,componentSystem);
        else
                return NULL;
}
#endif

// Initializes the ROSShowSpark component.

void ROSShowSpark::init(void){
...
/// Uninitializes the ROSShowSpark component.

void ROSShowSpark::quit(void) {
}

void ROSShowSpark::process(){
	ros::NodeHandle n;
