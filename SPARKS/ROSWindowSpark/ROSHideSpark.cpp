...
{
        if (!strcmp(componentType, "ROSHideSpark"))
                return new ROSHideSpark(componentInstanceName,componentSystem);
        else
                return NULL;
}
#endif

// Initializes the ROSHideSpark component.

void ROSHideSpark::init(void){
...
/// Uninitializes the ROSHideSpark component.

void ROSHideSpark::quit(void) {
}

void ROSHideSpark::process(){
	ros::NodeHandle n;
